<?php namespace semuscrud\crudbooster;

use semuscrud\crudbooster\commands\CrudboosterVersionCommand;
use semuscrud\crudbooster\commands\Mailqueues;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\ServiceProvider;
use semuscrud\crudbooster\commands\CrudboosterInstallationCommand;
use semuscrud\crudbooster\commands\CrudboosterUpdateCommand;
...
class CRUDBoosterServiceProvider extends ServiceProvider
{
    ...
    {                                   
        ...
        $loader->alias('CRUDBooster', 'semuscrud\crudbooster\helpers\CRUDBooster');
        $loader->alias('CB', 'semuscrud\crudbooster\helpers\CB');
    }
