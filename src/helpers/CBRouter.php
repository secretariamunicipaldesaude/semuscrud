...
use semuscrud\crudbooster\middlewares\CBAuthAPI;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Route;

class CBRouter
{
    private static $cb_namespace = '\semuscrud\crudbooster\controllers';
    ...
    private static function userControllerRoute() {
        Route::group([
            'middleware' => ['web', '\semuscrud\crudbooster\middlewares\CBBackend'],
